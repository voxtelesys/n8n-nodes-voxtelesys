...
// Codex files are located by n8n purely by filename convention (the compiled
// `X.node.js` path with "on" appended), never imported, so tsc will not emit
// them. They have to be copied alongside the compiled node.
function copyCodex() {
